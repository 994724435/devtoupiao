...
<head>
	...
	<title>上海护理创新发明展</title>

	<!-- Bootstrap -->
	<link href="/devtoupiao/Public/Home/images/bootstrap.min.css" rel="stylesheet">
	<link href="/devtoupiao/Public/Home/images/main.css" rel="stylesheet">
	<link href="/devtoupiao/Public/Home/images/enter.css" rel="stylesheet">
	<style type="text/css">
		body{
			padding: 0;
			margin: 0;
	...
	<script src="/devtoupiao/Public/Home/images/jquery.min.js"></script>
	<script src="/devtoupiao/Public/Home/images/bootstrap.min.js"></script>
	<script src="/devtoupiao/Public/Home/images/jquery.particleground.min.js"></script>
</head>
<body>
<div id="particles">
	...
	<div class="intro" style="margin-top: -256.5px;">
				...
				<div class="col-md-3 col-sm-8 col-centered">
					<form method="post" id="register-form" autocomplete="off" action="" class="nice-validator n-default" novalidate>
						<div class="form-group">
							<input type="text" class="form-control input-lg" id="account" name="tel" placeholder="手机号验证" autocomplete="off" aria-required="true" data-tip="">
						</div>

						<div id="validator-tips" class="validator-tips"></div>

						<div class="form-group">
							<button type="submit" id="submit_button" class="btn btn-primary btn-lg btn-block">验 证</button>
		...
		<link rel="stylesheet" href="/devtoupiao/Public/Home/images/jquery.validator.css">
