		    ...
		    <table class="table">
		      <thead>
		        <!--<tr style="text-align: center;">-->
		           <!--<h3> <span><a href="/devtoupiao/index.php/Admin/Index/addproduct">添加展览</a></h3>-->
		        <!--</tr>-->
		        <tr>
		          <th>编号</th>
					<th>名称</th>
		      ...
		      <?php if(is_array($res)): foreach($res as $key=>$v): if(($i%2)==1){ echo "<tr class='active'>"; }else{ echo "<tr class='info'>"; } ?>
		          ...
		          <th scope="row"><?php echo ($v["cont"]); ?></th>
				 <th><?php echo ($v["name"]); ?></th>
				  <th style="width: 300px"><?php if($v["price"] == 1): ?>实物类<?php elseif($v["price"] == 2): ?>壁报类<?php elseif($v["price"] == 3): ?>多媒体类<?php endif; ?> </th>
				  <th><?php echo ($v["salenum"]); ?></th>
				   <th><a href="/devtoupiao/index.php/Admin/User/qrcode/id/<?php echo ($v["id"]); ?>" target="_blank">二 维 码</a> |<a href="/devtoupiao/index.php/Admin/Index/select?bianhao=<?php echo ($v["cont"]); ?>" target="_blank">详 情</a> | <a href="/devtoupiao/index.php/Admin/Index/editeproduct/id/<?php echo ($v["id"]); ?>">修 改</a> | <a href="/devtoupiao/index.php/Admin/Index/deleteproduct/id/<?php echo ($v["id"]); ?>">删 除</a></th>
		        </tr>
